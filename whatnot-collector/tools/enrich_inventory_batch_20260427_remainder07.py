...
REPORT_PATH = EXPORTS / "enrichment_batch_2026-04-27_remainder07_report.json"
...
SPECS = [
    {
        "barcode": "6291110115829",
        "name": "Al Rehab Atheer Eau de Parfum Spray 100ml (3.4 oz) Unisex Perfume",
        "size_ml": 100,
        "size_oz": 3.4,
        "gender": "Unisex",
    ...
    {
        "barcode": "6291110113498",
        "name": "Al Rehab Bissan Eau de Parfum Spray 100ml (3.4 oz) Men Perfume",
        "size_ml": 100,
        "size_oz": 3.4,
        "gender": "Men",
        "manufacturer": "Al Rehab Perfumes",
    ...
    {
        "barcode": "6291110117069",
        "name": "Al Rehab Choco Musk Marshmallow Eau de Parfum Spray 100ml (3.33 oz) Women Perfume",
        "size_ml": 100,
        "size_oz": 3.33,
        "gender": "Women",
        "manufacturer": "Al Rehab Perfumes",
    ...
    {
        "barcode": "6291110117076",
        "name": "Al Rehab Choco Musk Pistachio Eau de Parfum Spray 100ml (3.33 oz) Unisex Perfume",
        "size_ml": 100,
        "size_oz": 3.33,
        "gender": "Unisex",
        "manufacturer": "Al Rehab Perfumes",
    ...
    {
        "barcode": "6291110113375",
        "name": "Al Rehab Choco Musk Eau de Parfum Spray 100ml (3.33 oz) Unisex Perfume",
        "size_ml": 100,
        "size_oz": 3.33,
        "gender": "Unisex",
        "manufacturer": "Al Rehab Perfumes",
    ...
    },
    {
        ...
        "name": "Armaf Club De Nuit Untold Eau de Parfum Spray 106ml (3.6 oz) Unisex Perfume",
        "size_ml": 106,
        "size_oz": 3.6,
        "gender": "Unisex",
        "manufacturer": "Armaf Perfumes",
        "product_form": "Eau De Parfum",
    },
    {
        "barcode": "6281110049187",
        "name": "Al Rehab Dhikra Eau de Parfum Spray 50ml (1.69 oz) Unisex Perfume",
        "size_ml": 50,
        "size_oz": 1.69,
        "gender": "Unisex",
        "manufacturer": "Al Rehab Perfumes",
    ...
    },
    {
        ...
        "name": "Maison Alhambra Jean Lowe Vibe Eau de Parfum Spray 100ml (3.4 oz) Unisex Perfume",
        "size_ml": 100,
        "size_oz": 3.4,
        "gender": "Unisex",
    ...
    },
    {
        ...
        "name": "Maison Alhambra Jorge Di Profumo Eau de Parfum Spray 100ml (3.4 oz) Men Perfume",
        "size_ml": 100,
        "size_oz": 3.4,
        "gender": "Men",
        "manufacturer": "Lattafa Perfumes Industries L.L.C",
    ...
    },
    {
        ...
        "name": "Dumont Nitro Pour Homme Eau de Parfum Spray 100ml (3.4 oz) Men Perfume",
        "size_ml": 100,
        "size_oz": 3.4,
        "gender": "Men",
...
for spec in SPECS:
    ...
    keywords = ", ".join(
        filter(
            ...
            [
                brand,
                spec["name"].split(" Spray ")[0].replace("  ", " ").strip(),
                spec["product_form"],
                gender,
                f"{spec['size_ml']}ml",
                f"{spec['size_oz']} oz",
