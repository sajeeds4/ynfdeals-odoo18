...
REPORT_PATH = EXPORTS / "enrichment_batch_2026-04-27_remainder09_report.json"
...
SEEDS: list[ProductSeed] = [
    ...
    ProductSeed(
        ...
        description_intro="A sweet gourmand eau de parfum with bright citrus and amber on top, creamy vanilla through the heart, and a cozy amber-musk finish.",
        top_notes="Citrus, Amber",
        mid_notes="Vanilla",
        base_notes="Amber, Musk",
        scent="Gourmand sweet vanilla",
