...
class YNFCustomerPortal(CustomerPortal):
    ...
    def _prepare_sale_portal_rendering_values(
        ...
        # Smaller step so each portal page renders a reasonable number of
        # session-grouped parcel cards instead of an endless scroll.
        step = 30
...
class YNFDisputeController(http.Controller):
    ...
    def help_pick_session(self, **kw):
        ...
        return request.render("ynf_website_theme.portal_help_pick_session",
    ...
    def help_pick_product(self, session_no, **kw):
        ...
        return request.render("ynf_website_theme.portal_help_pick_product",
    ...
    def help_submit(self, order_id=None, line_id=None, session_no=None,
        ...
        return request.render(
            "ynf_website_theme.portal_help_thanks",
